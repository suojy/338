...
def get_topwords():
  ...
  'puppy',
  'westsidestory'],
        "The Secret of the Biological Clock": ['shade',
  'ikr',
  'presented',
  'meet',
  'https',
  ...
  'games',
  'wooemmawatson'],
        "Mary Shelley's Frankenstein":['disgusting',
  'jason',
  'bed',
  'nightmare',
  'chucky',
  ...
  'alum',
  'jillspin'],
        "The Adventures of Augie March": ['india',
  'progressive',
  'hindu',
  'bran',
  'ida',
  ...
  'na',
  'adk'],
        "The Princess And the Pea":['giveaway',
  'maryland',
  'otd',
  'fore',
  'qu',
